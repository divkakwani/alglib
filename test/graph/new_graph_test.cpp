#include <iostream>
#include "../../src/containers/graph/graph.h"
#include "../../src/containers/graph/undirected_graph.h"
#include "../../src/containers/graph/vertex.h"
#include "../../src/containers/graph/edge.h"
#include <string>
#include <map>
//#include "../../src/algorithms/graph/search.h"
#include <unistd.h>
using namespace std;
...
/*
  ...
  vector<Person*> adj;
  G.adjTo(p2, back_inserter(adj));

  cout << "Persons adjacent to Divyanshu\n";
  for(auto it = adj.begin(); it != adj.last(); it++)
